...
/*
   Parameters:
     ...
     INPUT_Y = 16h0002
     OPCODE = 6b000100
     EXPECTED_OUTPUT = 16h0006
*/
module statement_tester_13 (
    input clk,
    input rst,
    input start,
    input error,
  ...
  localparam TEST_ID_LOW = 3'h6;
  localparam INPUT_X = 16'h0003;
  localparam INPUT_Y = 16'h0002;
  localparam OPCODE = 6'h04;
  localparam EXPECTED_OUTPUT = 16'h0006;
  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      DISP_OUT_2_state: begin
        ...
        if (M_slow_clk_edge_out && fin_out == 16'h0006) begin
