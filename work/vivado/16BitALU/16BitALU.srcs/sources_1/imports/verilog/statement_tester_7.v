...
/*
   Parameters:
     ...
     INPUT_Y = 16h0002
     OPCODE = 6b000000
     EXPECTED_OUTPUT = 16h0003
*/
module statement_tester_7 (
    input clk,
    input rst,
    input start,
    input error,
  ...
  localparam TEST_ID_LOW = 1'h0;
  localparam INPUT_X = 16'h0001;
  localparam INPUT_Y = 16'h0002;
  localparam OPCODE = 6'h00;
  localparam EXPECTED_OUTPUT = 16'h0003;
  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      DISP_OUT_2_state: begin
        ...
        if (M_slow_clk_edge_out && fin_out == 16'h0003) begin
