...
/*
   Parameters:
     ...
     INPUT_Y = 16h0000
     OPCODE = 6b000001
     EXPECTED_OUTPUT = 16h0000
*/
module statement_tester_12 (
    input clk,
    input rst,
    input start,
    input error,
  ...
  localparam TEST_ID_LOW = 3'h5;
  localparam INPUT_X = 16'h7fff;
  localparam INPUT_Y = 16'h0000;
  localparam OPCODE = 6'h01;
  localparam EXPECTED_OUTPUT = 16'h0000;
  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      DISP_OUT_2_state: begin
        ...
        if (M_slow_clk_edge_out && fin_out == 16'h0000) begin
