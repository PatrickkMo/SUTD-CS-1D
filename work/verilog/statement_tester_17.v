...
/*
   Parameters:
     ...
     INPUT_Y = 16h0008
     OPCODE = 6b100000
     EXPECTED_OUTPUT = 16hff00
*/
module statement_tester_17 (
    input clk,
    input rst,
    input start,
    input error,
  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      DISP_OUT_2_state: begin
        ...
        if (M_slow_clk_edge_out && fin_out == 16'hff00) begin
