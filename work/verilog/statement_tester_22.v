...
/*
   Parameters:
     ...
     INPUT_Y = 16hf007
     OPCODE = 6b111011
     EXPECTED_OUTPUT = 16hf007
*/
module statement_tester_22 (
    input clk,
    input rst,
    input start,
    input error,
  ...
  localparam TEST_ID_LOW = 3'h7;
  localparam INPUT_X = 16'h0202;
  localparam INPUT_Y = 16'hf007;
  localparam OPCODE = 6'h3b;
  localparam EXPECTED_OUTPUT = 16'hf007;
  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      DISP_OUT_2_state: begin
        ...
        if (M_slow_clk_edge_out && fin_out == 16'hf007) begin
